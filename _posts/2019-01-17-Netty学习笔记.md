...
#### 服务端启动
![avatar](https://github.com/yaabert/yaabert.github.io/blob/master/assets/photo/NettyServer.png)
...
#### 客户端启动
![avatar](https://github.com/yaabert/yaabert.github.io/blob/master/assets/photo/NettyClient.png)
...
#### 客户端重连
![avatar](https://github.com/yaabert/yaabert.github.io/blob/master/assets/photo/NettyConnect.png)
将connect()方法进行封装.通过addListener()方法监听连接是否成功,不成功时,递归调用封装好的connect方法进行固定次数重连.

#### 客户端与服务端双向通信

![avatar](https://github.com/yaabert/yaabert.github.io/blob/master/assets/photo/NettyServer-Client-Talk.png)
